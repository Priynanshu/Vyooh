  ...
  {yt.length > 0    && <ContentRail title="From YouTube" videos={yt} loading={loading} />}
        ...
        {!loading && videos.length === 0 && (
          <div className="flex flex-col items-center justify-center py-32 text-center px-4">
            ...
            <h2 className="text-white font-semibold text-lg mb-2">No content available now</h2>
            <p className="text-prime-muted text-sm">Please Try after some time when the content available.</p>
          </div>
        )}
      </div>
    </div>
